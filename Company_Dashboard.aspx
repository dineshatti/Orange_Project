<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Company_Dashboard.aspx.cs" Inherits="Orange_Project.Company_Dashboard" %>
		...
		<div class="container d-flex align-items-center">
			...
			<div id="ftco-nav">
				<ul class="navbar-nav m-auto">
					<li class="nav-item active"><a href="Company_Dashboard.aspx" class="nav-link">Home</a></li>
		...
		<div class="wrap-contact100">
			...
			<form runat="server" style="text-align: center">
				<center>
					...
					<asp:GridView ID="GridView1" runat="server" autogeneratecolumns="False" AlternatingRowStyle-CssClass="bottomBorder" RowStyle-CssClass="bottomBorder" HeaderStyle-CssClass="bottomBorder"  AlternatingRowStyle-BackColor="#3366FF" BackColor="White" HeaderStyle-BackColor="Black" HeaderStyle-ForeColor="White" Font-Bold="True" ForeColor="Black" CellPadding="20" >
					...
					<Columns>
						...
						<asp:boundfield datafield="Job Location" headertext="&nbsp;Job Location&nbsp;" />
						<asp:boundfield datafield="Skill" headertext="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Skill&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" />
						<asp:boundfield datafield="Closure Date" headertext="Closure Date" DataFormatString="{0:D}" />
						<asp:boundfield datafield="No of Candidates applied" headertext="No of Candidates applied" />
