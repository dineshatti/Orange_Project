<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Applied_Job.aspx.cs" Inherits="Orange_Project.Applied_Job" %>
		...
		<div class="container d-flex align-items-center">
			...
			<div id="ftco-nav">
				<ul class="navbar-nav m-auto">
					...
					<li class="nav-item active"><a href="Applied_Job.aspx" class="nav-link">Applied Jobs</a></li>
	...
	<section class="hero-wrap js-fullheight">
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" runat="server">
				...
				<asp:gridview id="AppliedJobsGridView" 
                AlternatingRowStyle-CssClass="bottomBorder" RowStyle-CssClass="bottomBorder" HeaderStyle-CssClass="bottomBorder"
       autogeneratecolumns="False"
       
       selectedindex="1"

       runat="server" Height="216px" Width="813px" AlternatingRowStyle-BackColor="#CCCCCC" AlternatingRowStyle-ForeColor="Black" AlternatingRowStyle-HorizontalAlign="Left" BackColor="White" Font-Bold="True" ForeColor="Black" HeaderStyle-BackColor="Black" HeaderStyle-ForeColor="White" RowStyle-ForeColor="Black" RowStyle-BackColor="White"> 
         ...
         <Columns>
			 ...
			 <asp:BoundField DataField="EntryDate" 
                 ...
                 SortExpression="Applied Date" DataFormatString="{0:D}" />
